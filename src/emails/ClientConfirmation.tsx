      ...
      <Tailwind>
        <Body className="bg-[#F9F8F6] my-auto mx-auto font-sans">
          <Container className="bg-white border border-[#EAEAEA] rounded-lg my-[40px] mx-auto p-[40px] w-[465px] shadow-sm">
            ...
            <Text className="text-[#6F6B65] text-[15px] leading-[26px]">
              Hemos registrado correctamente tu interés en nuestros servicios de
              ingeniería. Tu solicitud ha entrado en nuestra cola de evaluación
              prioritaria.
            </Text>
            ...
            {/* Próximos Pasos */}
            <Text className="text-[#6F6B65] text-[15px] leading-[26px]">
              <strong>¿Qué sigue?</strong> Un ingeniero de nuestro equipo
              analizará los requerimientos técnicos y te contactará vía WhatsApp
              o correo en las próximas 24 horas laborables.
            </Text>
            ...
            <Text className="text-[#9C9890] text-[12px] leading-[20px] text-center">
              ...
              <Link
                ...
                className="text-[#9C9890] underline"
              >
                Contactar Soporte
              </Link>
            </Text>

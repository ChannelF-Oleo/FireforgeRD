...
export function FAQSection() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <section
        id="faq"
        className="py-24 md:py-32 bg-[#F9F8F6] relative overflow-hidden"
      >
        {/* --- INYECCIÓN DE SEO --- */}
        <Script
          id="faq-schema"
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1A1818]/5 mb-6">
              <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase text-[#5C5850]">
            ...
            <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-light tracking-tight text-[#1A1818] mb-6">
              Preguntas
              <span className="bg-gradient-to-r from-[#FF4D00] via-[#FF6B2C] to-[#FF4D00] bg-clip-text text-transparent font-medium">
                {" "}
                Frecuentes
              </span>
            </h2>

            <p className="text-base md:text-lg text-[#5C5850] max-w-2xl mx-auto font-light text-balance">
              Aquí te explicamos cómo trabajamos, sin letras chiquitas ni
                ...
                <div className="space-y-4">
                  {category.questions.map((faq, index) => {
                    ...
                    return (
                      ...
                      >
                        <Card
                          className={`overflow-hidden border transition-colors duration-300 ${isOpen ? "border-[#FF4D00]/20 bg-white shadow-sm" : "border-transparent bg-white/50 hover:bg-white hover:border-[#1A1818]/5"}`}
                        >
                              ...
                              {isOpen && (
                                ...
                                >
                                  <div className="px-6 pb-6 pt-0">
                                    <p className="text-sm md:text-[15px] leading-relaxed text-[#5C5850]">
                                      {faq.a}
                                    </p>
                                  </div>
                                </m.div>
          ...
          <div className="text-center mt-20">
            <p className="text-sm text-[#9C9890] mb-4">

      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1A1818]/5 mb-6">
            <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase text-[#6F6B65]">
                    ...
                    >
                      ...
                      >
                        <CardContent className="p-0">
                          ...
                          >
                            <span
                              className={`text-sm md:text-base font-medium transition-colors text-balance ${isOpen ? "text-[#1A1818]" : "text-[#6F6B65] group-hover:text-[#1A1818]"}`}
                            >
                              {faq.q}
                            </span>

      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <div className="flex justify-center">
            <Link
              href="/clientes"
              className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white text-[#1A1818] rounded-full border border-[#1A1818]/10 hover:border-[#FF4D00]/30 hover:shadow-lg hover:shadow-[#FF4D00]/5 transition-all duration-300 cursor-pointer"
            >

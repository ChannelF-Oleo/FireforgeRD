      ...
      >
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base md:text-lg text-[#5C5850] font-light">
              ...
              <button
                ...
                className={`relative flex items-center gap-2 rounded-full px-4 py-2 md:px-6 md:py-3 text-xs md:text-sm font-medium transition-all duration-300 ${
                  activeCategory === cat.id
                    ...
                    : "bg-white text-[#5C5850] hover:bg-gray-50"
                }`}
              >
                {activeCategory === cat.id && (
                  <m.div
                    ...
                    >
                      ...
                      <div className="mb-6 relative z-10">
                        ...
                        <div className="inline-block px-2 py-1 bg-[#1A1818]/5 rounded-md mb-4">
                          <p className="text-[10px] text-[#5C5850] uppercase tracking-wider font-medium">
                            {plan.idealFor}
                          </p>
                        </div>
